...
export default function Progress() {
  ...
  return (
    <main className="min-h-screen bg-[#EFF6FF] p-6 md:p-12 mt-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Monitor your fitness metrics, celebrate achievements, and stay
            ...
            <form onSubmit={handleAddOrUpdateGoal} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewGoal({ ...newGoal, percentage: e.target.value })
                  }
                  placeholder="0"
                  min="0"
                  max="100"
