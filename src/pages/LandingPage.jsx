...
export default function LandingPage() {
  ...
  const Features = () => (
    <section className="min-h-screen flex items-center py-20 md:py-32" style={{ backgroundColor: "#EFF6FF" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-16">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex flex-col items-center text-center"
              >
  ...
  const testimonials = [
    { 
      ...
      avatar: "/avatars/john.jpg", // <-- use public folder
    },
    { 
      name: "Raj lama", 
      rating: 5, 
